                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                                ...
                                <input class="form-control" id="inputrole_name" type="text" name="role_name" value="<?= input_print($role->name) ?>" placeholder="Entry role name...!" required="required">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php if ($permission->perm_view_exists) : ?>
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" role="switch" id="view-<?= $permission->id ?>" name="<?= "permissions[{$permission->key}][view]" ?>" value="1" <?= ($permission->perm_view) ? 'checked' : '' ?> <?= ($role->id == 1 && $permission->key == 'admin_roles') ? 'disabled' : '' ?>>
                                                ...
                                                <td class="text-center">
                                                    <?php if ($permission->perm_add_exists) : ?>
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" role="switch" id="add-<?= $permission->id ?>" name="<?= "permissions[{$permission->key}][add]" ?>" value="1" <?= ($permission->perm_add) ? 'checked' : '' ?> <?= ($role->id == 1 && $permission->key == 'admin_roles') ? 'disabled' : '' ?>>
                                                ...
                                                <td class="text-center">
                                                    <?php if ($permission->perm_edit_exists) : ?>
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" role="switch" id="edit-<?= $permission->id ?>" name="<?= "permissions[{$permission->key}][edit]" ?>" value="1" <?= ($permission->perm_edit) ? 'checked' : '' ?> <?= ($role->id == 1 && $permission->key == 'admin_roles') ? 'disabled' : '' ?>>
                                                ...
                                                <td class="text-center">
                                                    <?php if ($permission->perm_delete_exists) : ?>
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" role="switch" id="delete-<?= $permission->id ?>" name="<?= "permissions[{$permission->key}][delete]" ?>" value="1" <?= ($permission->perm_delete) ? 'checked' : '' ?> <?= ($role->id == 1 && $permission->key == 'admin_roles') ? 'disabled' : '' ?>>
